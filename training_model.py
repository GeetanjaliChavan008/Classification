...
predictors = df.drop(['Survived', 'PassengerId'], axis=1)  # it is x without this tow columns
target = df["Survived"]                                    # this is y target variable
...
filename = 'titanic_model.sav'        #trained model save in this file
